...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="{{URL::to('assets/css/slick-theme.css')}} ">
        <link rel="stylesheet" href="{{URL::to('assets/css/animate.css')}}">
        <link rel="stylesheet" href="{{URL::to('assets/css/fonticons.css')}}">
    ...
    <body data-spy="scroll" data-target=".navbar-collapse">
        ...
        <div class="culmn">
            ...
            <script src=" {{URL::to('assets/js/gmaps.min.js')}} "></script>
